...
public class SpawnerScript : MonoBehaviour {
    ...
    void Start () {
        ...
        //Humans
        spawns.Add(new SpawnerDetails("HA1A2", "HUMAN", 1.7f, 284f, Quaternion.Euler(0, 90, 0)));

        spawns.Add(new SpawnerDetails("HA2A1", "HUMAN", 1.7f, 427.7f, Quaternion.Euler(0, 90, 0)));
        spawns.Add(new SpawnerDetails("HA2B1", "HUMAN", 1.7f, 427.7f, Quaternion.Euler(0, 90, 0)));
        spawns.Add(new SpawnerDetails("HA2D2", "HUMAN", 1.7f, 427.7f, Quaternion.Euler(0, 90, 0)));
        ...
        spawns.Add(new SpawnerDetails("HB1D1", "HUMAN", 260.4f, 509.6f, Quaternion.Euler(0, 165, 0)));

        spawns.Add(new SpawnerDetails("HB2B1", "HUMAN", 140.6f, 508.6f, Quaternion.Euler(0, 195, 0)));


        //Boats
        spawns.Add(new SpawnerDetails("", "BOAT", 1989f, 486f, Quaternion.Euler(0, 215, 0)));
        spawns.Add(new SpawnerDetails("", "BOAT", 1709f, 21f, Quaternion.Euler(0, 35, 0)));
